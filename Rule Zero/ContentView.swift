...
//            }
    ...
    //            }
            ...
            Button("Save") {
                ...
                let ruleBook = RuleBook(id: nil, colors: selectedColors, format: selectedFormat, budgetConstraints: selectedBudgetOption, limited: selectedLimitedFormat, matchType: selectedMatchType)
